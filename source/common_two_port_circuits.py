...
class SeriesImpedanceCircuit:
    ...
    def get_delta_abcd(self, at_frequency):
        self.__delta_abcd = (self.__parameter_a * self.__parameter_d) - (self.impedance.get_impedance(at_frequency=at_frequency) * self.__parameter_c)

        return  int(self.__delta_abcd.real)

    def get_matrix_abcd(self, at_frequency):
        self.__matrix_abcd = np.matrix([[self.__parameter_a, self.impedance.get_impedance(at_frequency=at_frequency)],[self.__parameter_c, self.__parameter_d]])
...
class ShuntImpedanceCircuit:
    ...
    # Public class methods
    def get_delta_abcd(self, at_frequency):
        self.__delta_abcd = (self.__parameter_a * self.__parameter_d) - (self.__parameter_b * self.admittance.get_admittance(at_frequency=at_frequency))

        return  int(self.__delta_abcd.real)

    def get_matrix_abcd(self, at_frequency):
        self.__matrix_abcd = np.matrix([[self.__parameter_a, self.__parameter_b],[self.admittance.get_admittance(at_frequency=at_frequency), self.__parameter_d]])
...
class TCircuit:
    ...
    def __get_parameter_a(self, at_frequency):
        impedance_z_a = self.impedance_a.get_impedance(at_frequency=at_frequency)
        impedance_z_c = self.impedance_c.get_impedance(at_frequency=at_frequency)
    ...
    def __get_parameter_b(self, at_frequency):
        impedance_z_a = self.impedance_a.get_impedance(at_frequency=at_frequency)
        impedance_z_b = self.impedance_b.get_impedance(at_frequency=at_frequency)
        impedance_z_c = self.impedance_c.get_impedance(at_frequency=at_frequency)
